...
public class CustomELVAdapter extends BaseExpandableListAdapter implements ExpandableListAdapter {
    ...
    private static final int GROUP_ITEM_RESOURCE = R.layout.list_group1;
    private static final int CHILD_ITEM_RESOURCE = R.layout.list_item1;


    public CustomELVAdapter(Context context, Activity activity, String[] groupname,
                            int[] ImgBckgrnd, String [][] listinfo, String[][] data){
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (child != null) {
             ...
             * **/
            holder.ExpCol.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
    ...
    public String getList(int groupPosition, int childPosition){
        Log.i("----gpos----",""+groupPosition+";;;"+childPosition);
